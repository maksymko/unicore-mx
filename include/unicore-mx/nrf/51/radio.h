...
#define RADIO_PCNF0_LFLEN_MASKED(V)			(((V) << RADIO_PCNF0_LFLEN_SHIFT) & RADIO_PCNF0_LFLEN_MASK)

#define RADIO_PCNF0_S0LEN_SHIFT			(8)
#define RADIO_PCNF0_S0LEN_MASK			(1 << RADIO_PCNF0_S0LEN_SHIFT)
#define RADIO_PCNF0_S0LEN_MASKED(V)			(((V) << RADIO_PCNF0_S0LEN_SHIFT) & RADIO_PCNF0_S0LEN_MASK)

#define RADIO_PCNF0_S1LEN_SHIFT			(16)
#define RADIO_PCNF0_S1LEN_MASK			(0xf << RADIO_PCNF0_S1LEN_SHIFT)
#define RADIO_PCNF0_S1LEN_MASKED(V)			(((V) << RADIO_PCNF0_S1LEN_SHIFT) & RADIO_PCNF0_S1LEN_MASK)

#define RADIO_PCNF1_MAXLEN_SHIFT			(0)
#define RADIO_PCNF1_MAXLEN_MASK			(0xff << RADIO_PCNF1_MAXLEN_SHIFT)
#define RADIO_PCNF1_MAXLEN_MASKED(V)			(((V) << RADIO_PCNF1_MAXLEN_SHIFT) & RADIO_PCNF1_MAXLEN_MASK)

#define RADIO_PCNF1_STATLEN_SHIFT			(8)
#define RADIO_PCNF1_STATLEN_MASK			(0xff << RADIO_PCNF1_STATLEN_SHIFT)
#define RADIO_PCNF1_STATLEN_MASKED(V)			(((V) << RADIO_PCNF1_STATLEN_SHIFT) & RADIO_PCNF1_STATLEN_MASK)

#define RADIO_PCNF1_BALEN_SHIFT			(16)
#define RADIO_PCNF1_BALEN_MASK			(7 << RADIO_PCNF1_BALEN_SHIFT)
#define RADIO_PCNF1_BALEN_MASKED(V)			(((V) << RADIO_PCNF1_BALEN_SHIFT) & RADIO_PCNF1_BALEN_MASK)
...
#define RADIO_PREFIX0_AP0_MASKED(V)			(((V) << RADIO_PREFIX0_AP0_SHIFT) & RADIO_PREFIX0_AP0_MASK)

#define RADIO_PREFIX0_AP1_SHIFT			(8)
#define RADIO_PREFIX0_AP1_MASK			(0xff << RADIO_PREFIX0_AP1_SHIFT)
#define RADIO_PREFIX0_AP1_MASKED(V)			(((V) << RADIO_PREFIX0_AP1_SHIFT) & RADIO_PREFIX0_AP1_MASK)

#define RADIO_PREFIX0_AP2_SHIFT			(16)
#define RADIO_PREFIX0_AP2_MASK			(0xff << RADIO_PREFIX0_AP2_SHIFT)
#define RADIO_PREFIX0_AP2_MASKED(V)			(((V) << RADIO_PREFIX0_AP2_SHIFT) & RADIO_PREFIX0_AP2_MASK)

#define RADIO_PREFIX0_AP3_SHIFT			(24)
#define RADIO_PREFIX0_AP3_MASK			(0xff << RADIO_PREFIX0_AP3_SHIFT)
#define RADIO_PREFIX0_AP3_MASKED(V)			(((V) << RADIO_PREFIX0_AP3_SHIFT) & RADIO_PREFIX0_AP3_MASK)

#define RADIO_PREFIX1_AP4_SHIFT			(0)
#define RADIO_PREFIX1_AP4_MASK			(0xff << RADIO_PREFIX1_AP4_SHIFT)
#define RADIO_PREFIX1_AP4_MASKED(V)			(((V) << RADIO_PREFIX1_AP4_SHIFT) & RADIO_PREFIX1_AP4_MASK)

#define RADIO_PREFIX1_AP5_SHIFT			(8)
#define RADIO_PREFIX1_AP5_MASK			(0xff << RADIO_PREFIX1_AP5_SHIFT)
#define RADIO_PREFIX1_AP5_MASKED(V)			(((V) << RADIO_PREFIX1_AP5_SHIFT) & RADIO_PREFIX1_AP5_MASK)

#define RADIO_PREFIX1_AP6_SHIFT			(16)
#define RADIO_PREFIX1_AP6_MASK			(0xff << RADIO_PREFIX1_AP6_SHIFT)
#define RADIO_PREFIX1_AP6_MASKED(V)			(((V) << RADIO_PREFIX1_AP6_SHIFT) & RADIO_PREFIX1_AP6_MASK)

#define RADIO_PREFIX1_AP7_SHIFT			(24)
#define RADIO_PREFIX1_AP7_MASK			(0xff << RADIO_PREFIX1_AP7_SHIFT)
#define RADIO_PREFIX1_AP7_MASKED(V)			(((V) << RADIO_PREFIX1_AP7_SHIFT) & RADIO_PREFIX1_AP7_MASK)
...
#define RADIO_CRCCNF_LEN_MASKED(V)			(((V) << RADIO_CRCCNF_LEN_SHIFT) & RADIO_CRCCNF_LEN_MASK)
